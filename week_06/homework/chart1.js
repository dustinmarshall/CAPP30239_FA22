...
d3.csv('a3cleanedonly2015_chart1.csv').then(data => {

    // (4) CALL FUNCTION WITH OPTIONAL PARAMS
    let chart = BarChart(data, {
        x: d => d.state,
        y: d => d.percent_armed_gun,
        xDomain: d3.groupSort(data, ([d]) => -d.percent_armed_gun, d => d.state), // sort by descending frequency
        yFormat: "%",
        yLabel: "↑ Frequency",
        width: 1000,
        height: 500,
