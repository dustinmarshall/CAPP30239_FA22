...
Let's practice D3. We will be using a bar chart to display library visits for the public libraries around the University of Chicago. 

<a href="library_visits_jan22.csv">Library visits data</a> comes from the Chicago Data Portal.

## Find Data for your Final
